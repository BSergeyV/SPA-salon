...
<!--Шапка с фото салона (CSS)-->
    ...
    <div class="figure-container">
        ...
        <figure>
            <div class="img-container">
                <img src="images/massage.avif" alt="Trulli">
             </div>

            <figcaption>Массаж с аромамаслами</figcaption>
            <?php
        ...
        <figure>
            <div class="img-container">            
                <img src="images/hot_stones.avif" alt="Trulli">
            </div>
        ...
        <figure>
            <div class="img-container">
                <img src="images/face_mask.avif" alt="Trulli">
            </div>
            
            <figcaption>Маска для лица на выбор</figcaption>
            <?php
        ...
        <figure>
            <div class="img-container">
                <img src="images/face.avif" alt="Trulli">
            </div>
    ...
    <footer>
        <div class="contact_details">
            <div class="contact">Адрес: <b><i>город, уилица и дом</i></b></div>
            <div class="contact">Телефон: <b>789-78-78</b></div>
            <div class="contact">Email: <b><i>qwerty@mail.com</i></b></div>
        </div>
    </footer>
